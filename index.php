    ...
    "poid": 84
        ...
        foreach ($equipes as $equipe) {  ?>
            <div>
                ...
                <img class="imageEquipe" src="<?php echo $equipe->logo; ?>" width="100px" height="100px" />
            ...
            if($joueur->equipe == $equipe->id ){ 
                ...
                ?>
                        ...
                        <div class='element'><img src='https://cdn-icons-png.flaticon.com/512/2468/2468023.png' title='2' width="50px" height="50px" alt='<?php echo $joueur->nom  ?>'>
                            <p> <strong> <?php echo $joueur->nom; ?> </strong>  <br>
                                poids : <?php echo $joueur->poid; ?> kg <br>
                                taille :<?php echo $joueur->taille;  ?> m <br>
                                numéro : <?php echo $joueur->No;  ?> <br>
                                poste : <?php echo  $joueur->position;  ?></p>
                        </div>
            ...
            if($totalPlayerByTeam == 0){?>
               <?php echo "Aucun joueur enregistré pour cette équipe  dans l'api" ?> 
            <?php }
            $totalPlayerByTeam = 0;
            ?> 
